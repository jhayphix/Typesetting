...
\begin{document}
	...
	\begin{frame}{Introduction}
		...
		Data spanning \textPrimary{\startDate} to \textPrimary{\finishDate} are obtained from the National Petroleum Authority of Ghana, covering four petroleum products; \textPrimary{Gasoline, Gasoil, Kerosene, and Liquefied Petroleum Gas (LPG) }. 
	\end{frame}
	% --------------------------------------------------------------------
