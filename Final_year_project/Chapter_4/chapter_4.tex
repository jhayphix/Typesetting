...
\begin{document}
	...
	\newcommand{\VARHighlight}{\textcolor{\highlight}{Vector Autocorelation } }
	\newcommand{\VEC}{Vector Error Correlation }
	\newcommand{\VECHighlight}{\textcolor{\highlight}{Vector Error Correlation } }
...
LPG      & 5         & -1.975 & 1.497     & 0.587  & 0.010          \\ \hline
	...
	\begin{frame}{Estimation of VAR/ VEC Models}
		\begin{block}{}
			...
			covariance stationary \vspace{5pt}
		\end{block} \vspace{5pt}
		
		VAR for instance cannot be used if the variables are not stationary 
		Also, if the data is non-stationary, the forecast cannot be done because VAR assumes 
		stationarity
